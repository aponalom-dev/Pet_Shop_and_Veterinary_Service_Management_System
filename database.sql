...
(3, 9, 'Veterinary Care', 'Details pending', 0, 0.00, 'Schedule pending', 'Schedule pending', 'Sample doctor profile. Add verified qualifications, consultation fee, and schedule before accepting appointments.', 'Unavailable', '2026-09-13 00:00:00', '2026-09-13 00:00:00');
...
(4, 'Dr. Hasan Rahman', 'dr_hasan', 'doctor1@pawcare.com', '01700000004', 'Male', '$2y$12$oCi9cf6OD5VZQ3PSLTazseYX.VnAhKTWlTpVeqYzjNa/AzxmhRw0u', 'doctor', 'Apon.jpg', 'Dhanmondi, Dhaka', 'active', '2026-08-26 07:41:45', '2026-08-26 07:41:45'),
(5, 'Dr. Nusrat Jahan', 'dr_nusrat', 'doctor2@pawcare.com', '01700000005', 'Female', '$2y$12$oCi9cf6OD5VZQ3PSLTazseYX.VnAhKTWlTpVeqYzjNa/AzxmhRw0u', 'doctor', 'Era.jpg', 'Banani, Dhaka', 'active', '2026-08-26 07:41:45', '2026-08-26 07:41:45'),
...
(9, 'Dr. Sumiya Rahman Hadir', 'dr_sumiya_hadir', 'sumiya.hadir@pawcare.test', '01700000012', 'Female', '$2y$10$2N3g8sV8n3rzdhwFTLFNmuPSAqpgzu6av2DLf3lIO15VoZv5S5yFK', 'doctor', 'Hadir.jpg.jpg', NULL, 'active', '2026-09-13 00:00:00', '2026-09-13 00:00:00');
...
-- Delivery company assignments used by the delivery portal.
CREATE TABLE `delivery_agents` (
  ...
  CONSTRAINT `delivery_agents_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `delivery_agents` (`user_id`, `company_name`, `status`) VALUES
(6, 'Pathao Fast', 'Active'),
(7, 'Jhinku BD', 'Active');
